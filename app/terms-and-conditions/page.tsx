          ...
          <div className="prose prose-lg max-w-none">
            ...
            <div className="bg-green-50 p-6 rounded-lg mt-8">
              ...
              <p className="text-gray-700">
                If you have any questions about these Terms and Conditions, please contact us at gorkhaleaf@gmail.com or call +91-7204390477. We are committed to addressing your concerns and ensuring a positive experience with Gorkha Leaf.
              </p>
            </div>
          </div>
        </div>

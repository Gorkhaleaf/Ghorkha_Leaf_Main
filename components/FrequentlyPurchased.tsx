      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 justify-items-center">
          {products.map((product) => (
            <div
              key={product.id}
              className="group bg-white border border-gray-200 rounded-xl overflow-hidden hover:shadow-xl hover:border-green-500/20 transition-all duration-300 cursor-pointer flex flex-col min-h-[400px] w-full max-w-[280px]"
            >
              ...
              <div className="flex flex-col flex-1 p-3">
                <div className="flex-1 mb-3 min-h-[120px]" onClick={() => window.location.href = `/products/${product.slug}`}>
                  <Link href={`/products/${product.slug}`}>
                    <h3 className="font-semibold text-gray-900 line-clamp-2 group-hover:text-green-600 transition-colors duration-200 text-sm leading-tight mb-2 min-h-[2.5rem]">
                      {product.name}
                    </h3>
                  </Link>
                ...
                <button
                  ...
                  className={`w-full py-2.5 rounded-lg font-semibold text-xs transition-colors h-10 flex items-center justify-center ${

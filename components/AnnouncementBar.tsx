export function AnnouncementBar() {
  const announcementText = "⚡ Quick delivery across India    •    ⚡ Ship within 24 hours    •    🎉 Free delivery for orders above ₹999*    •    🍃 Authentic teas & wellness blends    •    ✋ Handpicked quality, packed fresh    •    🏔️ From the hills to your cup";
